...
`incidence::estimate_peak`) will eventually find there way in to a smaller,
separate, package called
[`incidence2extra`](https://github.com/reconhub/incidence2extra).  Here they
will have a more consistent interface, better choice of underlying models, and
tidier outputs. 
