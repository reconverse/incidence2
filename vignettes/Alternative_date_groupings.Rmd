...
For this reason we also the provide the function `as_incidence()`, where you can specify the function you wish to apply.
We illustrate this approach using both the [clock](https://clock.r-lib.org) and [zoo](https://cran.r-project.org/package=zoo) packages.
...
## Month grouping based on [clock](https://clock.r-lib.org) functions
