...
i_epiet %>% plot(color = "white", show_cases = TRUE, angle = 45, size = 10, n.breaks = 20)
```
...
```{r, facets}
i %>% facet_plot(facets = gender, n.breaks = 3)
i %>% facet_plot(facets = hospital, fill = gender, n.breaks = 3, nrow = 4)
...
```{r, palettes}
i %>% regroup(hospital) %>% plot(fill = hospital, col_pal = rainbow, n.breaks = 3) # see ?rainbow
