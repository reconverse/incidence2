...
* `get_count_names()`, `get_dates_name()`, and `get_group_names()` all return
  character vectors of the column names corresponding to the requested variables.
