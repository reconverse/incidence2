...
```{r}
# get the linelist from the simulated ebola outbreak
...
now also provide the `counts` variable(s) that we are interested in.

Before continuing, take note of the missing values, in the Covid data above. If
these occur in one of the count variables, `incidence()` will warn users:
